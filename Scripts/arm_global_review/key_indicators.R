...
df_ki_final %>% 
  ...
  si_style_xgrid() +
  labs(x = NULL, y = NULL,
       subtitle = paste(current_month, "Status of VAS in Risk Level 1 (n=1,771) 2 (n=447) and 3 (n=251) Counties")) +
...
si_save("Images/2024_gr/vas_key_indicators_update_2")
